...
import { getConnection, setConnection } from '../../reference-postgres/src/conn.js';
import { testWord } from '../../reference-postgres/src/characters.js';
import { getOriginalText, wordConjData } from '../../reference-postgres/src/dict/conjugation.js';
import { calcScore as currentCalcScore } from '../../reference-postgres/src/dict/scoring.js';
import { getSplitImpl } from '../../reference-postgres/src/dict/splitQueries.js';
// Populates the current analyzer's split maps before querying them.
import '../../reference-postgres/src/dict/splitDefinitions.js';
import type { ConjData, KanaText, KanjiText, Reading } from '../../reference-postgres/src/types.js';
