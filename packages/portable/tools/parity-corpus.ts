...
const FIXTURES = Object.freeze({
  'packages/core/tests/data/segmentation.json':
  ...
  'packages/cli/tests/data/cli-lisp-outputs.json':
    'f9857e5f8294c79a74d4c7769ff5b5fc9dad7a1e3f879720ca3f7e77d3227c99',
  ...
  'packages/cli/tests/data/hard-cli-lisp-outputs.json':
    '8e02980887f2c088349b50f41e43d33c51d6a7c741d66e40896cbfb2ba54f3d7'
});
...
async function entityFixtures(root: string): Promise<AnalyzerEntityFixture[]> {
  const path = join(root, 'packages/core/tests/entity-hints.test.ts');
...
export async function loadAnalyzerParityCorpus(root: string): Promise<AnalyzerParityCorpus> {
  const [segmentation, cliFile, hardFile, cliExpected, hardExpected, entities] = await Promise.all([
    lockedJson<SegmentationFixture[]>(root, 'packages/core/tests/data/segmentation.json'),
