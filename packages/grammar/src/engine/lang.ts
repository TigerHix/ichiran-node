...
import { V, node, edge, before, text, textRe, textOneOf, lemma, lemmaOneOf, pos, posOneOf, dep, depOneOf, inflectionForm, inflectionFormOneOf, conjugationClass, conjugationClassOneOf, tag, tagOneOf, not } from './dsl.js';
