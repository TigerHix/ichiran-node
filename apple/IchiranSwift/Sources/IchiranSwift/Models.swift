...
public struct IchiranTokenDetailsOptions: Codable, Sendable, Equatable {
...
public struct IchiranTokenDetailForm: Codable, Sendable, Equatable {
  public let text: String
  public let reading: String
}

public struct IchiranTokenConjugationProperty: Codable, Sendable, Equatable {
  public let pos: String
  public let type: Int
  public let negative: Bool
  public let formal: Bool
...
public struct IchiranTokenConjugation: Codable, Sendable, Equatable {
  public let root: IchiranTokenDetailForm?
  public let properties: [IchiranTokenConjugationProperty]
  public let meanings: [IchiranTokenMeaning]
  public let via: [IchiranTokenConjugation]
}

public struct IchiranTokenCounter: Codable, Sendable, Equatable {
