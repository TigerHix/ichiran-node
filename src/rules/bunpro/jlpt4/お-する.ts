...
export default linguisticRule('お-する', (r) => {
  ...
  r.either(
    ...
    // Pattern 16: NOUN compound starting with お/ご + します (polite)
    // Example: おやすみします, お願いします, お返事します
    // Note: Must exclude regular suru-verbs without humble prefix (e.g., 電話します)
    (b) => {
      const compound = b.tok({
        textRe: /^(お|ご)/,
        pos: 'NOUN',
    ...
    // Pattern 17: NOUN compound starting with お/ご + しました (polite past)
